...
Because SolidStart is built on top of Solid, styling is not limited to CSS. To see other ways to style components, see the [styling section in the Solid documentation](/solid-js/guides/styling-your-components).
