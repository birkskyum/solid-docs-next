...
- **FlowComponent:** Designed for components like [`<Show>`](/solid-js/reference/components/show) or [`<For>`](/solid-js/reference/components/for), typically requiring children and, occasionally, specific children types.
...
<Callout>
	...
	[`createMemo`](/solid-js/reference/basic-reactivity/create-memo),
	[`createRenderEffect`](/solid-js/reference/secondary-primitives/create-render-effect),
	and [`createComputed`](/solid-js/reference/secondary-primitives/create-computed).
</Callout>
